...
from .models import RoomImage, RoomInventory, RoomType
...
class RoomTypeAdmin(admin.ModelAdmin):
	fieldsets = (
		...
		('Room Details', {
			'fields': ('bed_type', 'max_guests', 'room_size_sqm', 'amenities'),
			'description': 'Bed type, guest capacity, size, and amenities list'
		}),
	)
