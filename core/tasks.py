...
def sync_supplier_inventory(self, property_id, supplier_name):
    ...
    try:
        from hotels.models import Property
        from hotels.inventory import InventorySource
        from hotels.supplier_adapters import SupplierAdapterFactory
...
def reconcile_inventory_mismatches(self):
    ...
    """
    try:
        from hotels.inventory import InventorySource, ExternalInventoryLog
        from hotels.supplier_adapters import InventoryReconciliationEngine
